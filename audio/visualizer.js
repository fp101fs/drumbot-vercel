...
class Visualizer {
  ...
  showInput(note, timeOffset) {
    ...
    this.vizInput = new mm.PianoRollSVGVisualizer(this.input, this.svgInput, this.cfgInput);
  }
  ...
  showDrums(drums, muted) {
    ...
    this.drums = drums;
    this.vizDrums = new mm.PianoRollSVGVisualizer(this.drums, this.svgDrums, this.cfgDrums);
  }
