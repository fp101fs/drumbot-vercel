...
class InputRecorder {
  constructor() {
    this.bpm = 120;
    this.player = new window.mm.SoundFontPlayer('https://storage.googleapis.com/magentadata/js/soundfonts/sgm_plus');
    this.viz = null;
  ...
  start(stopCallback) {
    ...
    this.viz = new window.mm.PianoRollSVGVisualizer(this.full, document.getElementById('svgInput'), {
      noteRGB: '255, 255, 255',
